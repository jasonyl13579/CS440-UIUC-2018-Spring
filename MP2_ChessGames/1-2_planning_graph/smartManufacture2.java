...
public class smartManufacture2
{
	private int[][] array;
	...
	private int rowSize;
	private int colSize;
	private Queue<smartManufactureState2> stateQueue;
	...
	private smartManufactureState2 nextState[];
	private ArrayList<ArrayList<Integer>> gadgets;
	private List<smartManufactureState2> closeList;
	private int[][] costMatrix;
	
	public smartManufacture2(int[][] array,int rowNumber,int colNumber)
	{
		this.array=array;
		...
		closeList=new ArrayList<smartManufactureState2>();
		this.stateQueue=new PriorityQueue<>(1, valueComparator);
		nextState = new smartManufactureState2[5];
		...
		//smartManufactureState2 state=new smartManufactureState2(array,rowNumber,colNumber,rowCount,colCount,gadgets);
	...
	public void smartManufactureAlgorithm()
	{
		...
		smartManufactureState2 root = new smartManufactureState2(array,rowNumber,colNumber,rowCount,colCount,gadgets);
		
		smartManufactureState2 stateNow = root;
		...
		while(end!=1)
		{
			...
			listToArray();
			nextState[0] = new smartManufactureState2(array,rowNumber,colNumber,rowCount,colCount,gadgets);
			...
			listToArray();
			nextState[1] = new smartManufactureState2(array,rowNumber,colNumber,rowCount,colCount,gadgets);
			...
			listToArray();
			nextState[2] = new smartManufactureState2(array,rowNumber,colNumber,rowCount,colCount,gadgets);
			...
			listToArray();
			nextState[3] = new smartManufactureState2(array,rowNumber,colNumber,rowCount,colCount,gadgets);
			...
			listToArray();
			nextState[4] = new smartManufactureState2(array,rowNumber,colNumber,rowCount,colCount,gadgets);
			...
			if(round!=0)
			{
				for(Iterator<smartManufactureState2> it=closeList.iterator();it.hasNext();)
				{
					smartManufactureState2 nodeTemp=it.next();
					int countA=0;
					int countB=0;
					int countC=0;
					int countD=0;
			...
			//stateQueue*************************************
			//StateChoosing
			smartManufactureState2 newState = stateQueue.poll();
			stateNow = newState;
		...
		Stack<smartManufactureState2> resultStack = new Stack<smartManufactureState2>();
	...
	public int calculatePathCost(smartManufactureState2 state)
	{
	...
	public void recoverState(smartManufactureState2 state)
	{
	...
	public void printFinalAnimation(Stack<smartManufactureState2> resultStack)
	{	
		smartManufactureState2 currentState;
	...
	public static Comparator<smartManufactureState2> valueComparator = new Comparator<smartManufactureState2>()
	{
        @Override
        public int compare(smartManufactureState2 c1, smartManufactureState2 c2)
		{
