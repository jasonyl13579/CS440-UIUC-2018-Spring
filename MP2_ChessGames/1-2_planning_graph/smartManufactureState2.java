...
public class smartManufactureState2
{
	private smartManufactureState2 parent;
	private int[][] array;
	...
	public smartManufactureState2(int[][] array,int rowNumber,int colNumber,int rowCount,int colCount,ArrayList<ArrayList<Integer>> gadgets)
	{
	...
	public void setParent(smartManufactureState2 parent)
	{
		this.parent=parent;
	}
	public smartManufactureState2 getParent()
	{
		return parent;
	}
