...
def scaleBall(unit):
	return 700*unit - LINETHICKNESS/2

def scalePaddle(unit):
	return 700*unit - LINETHICKNESS
...
if __name__=='__main__':
	if MODE == 'train':
		...
		paddle2 = pygame.Rect(paddle2_x, paddle2_y, LINETHICKNESS, paddle2_height)
		# wall
